...
<div class="hero-wrap js-fullheight" style="margin-top:-25px;background-image: url('{{ asset('assets/images/image_2.jpg') }}');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-services">
    	<div class="container">
            ...
            <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate mt-4">
              <div class="d-block services-wrap text-center">
                <div class="img" style="background-image: url({{asset('assets/images/'.$hotel->image.'.jpg')}});"></div>
